...
public class BasePresenter<V extends BaseView,M extends BaseModel> {
    ...
    public void attach(V view){
        ...
        if (is){
            ...
            throw new RuntimeException(mView.getClass().getName()+"   No implments interface" + BaseView.class.getName());
        }
    ...
    private void checkInterface() {
        Type[] params = (mView.getClass().getGenericInterfaces());
        for (Type param : params) {
            if (BaseView.class.isAssignableFrom((Class<?>) param)){
                is = true;
                return;
            }
        }
