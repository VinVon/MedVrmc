...
import com.medvision.vrmed.app.ProjectApplication;
...
//               Log.e(TAG, "当前时间=="+s.toString());
    ...
    public void writeRXCharacteristic(CommandHolder commandHolder)
    {
        ...
        //写入值
        RxChar.setValue(commandHolder.packets.get(0));
    ...
    public List<BluetoothGattService> getBLEServices(){
        ...
        if(mBluetoothGatt == null){
            Toast.makeText(ProjectApplication.getContext(), "BluetoothGatt is null", Toast.LENGTH_SHORT).show();
            return null;
        }
