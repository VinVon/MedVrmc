...
public class GrideAdapter extends RecyclerView.Adapter<GrideAdapter.MyViewHolder> {
    ...
    private int layout;
    public GrideAdapter(Context context,int layout) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        holder.patient_record.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                context.startActivity(new Intent(context, RecordActivity.class));
            }
        });
        holder.patient_train.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
